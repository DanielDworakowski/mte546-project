...
%   28/09/2011    SOH Madgwick    Initial release
    ...
    methods (Access = public)
        ...
        function obj = Update(obj, Gyroscope, Accelerometer, Magnetometer, timestep)
            obj.SamplePeriod = timestep;
        ...
        function obj = UpdateIMU(obj, Gyroscope, Accelerometer, timestep)
            obj.SamplePeriod = timestep;
            q = obj.Quaternion; % short name local variable for readability
